...
public class detalleBusquedaTurno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_busqueda_turno);
        ...
        Log.d("-->","ESTOY EN DETALLE BUSQUEDA TURNOS");
    ...
    public void back(View view) {
        Intent miIntent= new Intent(detalleBusquedaTurno.this, menuGeneral.class);
